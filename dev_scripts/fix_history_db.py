...
old_str = '''    query += " ORDER BY f.study_year DESC, c.semester DESC, c.name ASC, u.full_name ASC"
...
new_str = '''    query += " ORDER BY f.study_year DESC, c.semester DESC, c.name ASC, u.full_name ASC, r.submitted_at DESC"
